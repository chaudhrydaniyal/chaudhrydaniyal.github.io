                                    ...
                                    d
                                        ? yield ((n = { token: b, submissionObject: u(E) }),
                                          t(void 0, void 0, void 0, function* () {
                                            ...
                                            async function saveMessage(name, email,phone, message) {
                                            
                                                var currentdate = new Date();
                                            
                                                
                                                const userRef = db.doc(`messages/${email}${JSON.stringify(new Date())}`)
                                        ...
                                        : console.log(h, p,"not called"),
                                    f.classList.remove("d-none"),
                                    E.forEach((t) => {
                                        t.setAttribute("disabled", "");
                                    });
                            } catch (t) {
                                console.log("appeared in catch")
